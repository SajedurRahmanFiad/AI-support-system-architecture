...
class Settings(BaseSettings):
    ...
    handoff_confidence_threshold: float = Field(default=0.4, alias="HANDOFF_CONFIDENCE_THRESHOLD")
    prompt_recent_message_limit: int = Field(default=5, alias="PROMPT_RECENT_MESSAGE_LIMIT")
    ...
    facebook_message_batch_window_seconds: int = Field(default=15, alias="FACEBOOK_MESSAGE_BATCH_WINDOW_SECONDS")
